...
ace.define("ace/mode/javascript/jshint", [], function (
  require,
  exports,
  module
) {
          ...
          (function (global) {
            (function (global, factory) {
              ...
              function collectNonEnumProps(obj, _keys) {
                ...
                var proto =
                  (isFunction(constructor) && constructor.prototype) ||
                  ObjProto;
              ...
              function isFinite(obj) {
                return (
                  !isSymbol(obj) && _isFinite(obj) && !_isNaN(parseFloat(obj))
                );
              }
              function isNaN(obj) {
        ...
        function (_dereq_, module, exports) {
          ...
          var JSHINT = (function () {
            ...
            blockstmt("function", function (context) {
              ...
              var nameToken = optionalidentifier(context)
                ? state.tokens.curr
                : null;
          ...
          Lexer.prototype = {
            ...
            scanIdentifier: function (checks) {
              ...
              function removeEscapeSequences(id) {
                return id.replace(/\\u([0-9a-fA-F]{4})/g, function (
                  m0,
                  codepoint
                ) {
          ...
          var scopeManager = function (state, predefined, exported, declared) {
            ...
            var scopeManagerInst = {
              ...
              addParam: function (bindingName, token, type) {
                ...
                if (type === "exception") {
                  var previouslyDefinedBindingType = this.funct.bindingtype(
                    bindingName
                  );
                  if (
