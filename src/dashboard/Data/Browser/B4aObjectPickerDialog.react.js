...
import styles from 'dashboard/Data/Browser/B4aObjectPickerDialog.scss';
...
import stylesDataBrowserHeader from 'components/DataBrowserHeader/DataBrowserHeader.scss';
import stylesBrowserCell from 'components/BrowserCell/B4aBrowserCell.scss';
...
export default class B4aObjectPickerDialog extends React.Component {
  ...
  render() {
    ...
    return (
      <Popover fadeIn={true} fixed={true} position={origin} modal={true} color="rgba(17,13,17,0.8)">
        <div className={styles.objectPickerDialogWrapper}>
          {<Icon onClick={onCancel} width={10} height={10} className={styles.closeIcon} name="close" fill="#10203A" />}
          <div className={styles.header}>
            <div className={styles.title}>{`Select ${column.name}`}</div>
            <div className={styles.subtitle}>{`${column.type} <${column.targetClass}>`}</div>
          </div>
          <div
            className={[
              ...
              stylesDataBrowserHeaderBar.objectPickerContent,
              stylesDataBrowserHeader.objectPickerContent,
              stylesBrowserCell.objectPickerContent,
          ...
          <div className={styles.footer}>
            ...
            <div>
              <Button value="Cancel" color="white" width="auto" onClick={onCancel} additionalStyles={{ border: '1px solid #ccc', color: '#303338', marginRight: '0.5rem' }} />
              <Button
                primary={true}
