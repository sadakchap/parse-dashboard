...
import B4aChip from 'components/Chip/B4aChip.react';

export default class B4aMultiSelect extends React.Component {
  constructor() {
    super();
    this.state = {
      open: false,
...
B4aMultiSelect.propTypes = {
  ...
  children: PropTypes.node.isRequired.describe(
    'The children of B4aMultiSelect should only be <Option> components.'
  ),
