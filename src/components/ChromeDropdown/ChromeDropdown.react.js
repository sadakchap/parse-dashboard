...
export default class ChromeDropdown extends React.Component {
  ...
  render() {
    ...
    const isMultipleOptions = this.props.options.length > 1;
    const labelDivStyle = isMultipleOptions ? [styles.current, styles[color]] : [styles.withoutArrow, styles.disabled, styles[color]];
