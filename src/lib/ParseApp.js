...
export default class ParseApp {
  ...
  async fetchSettingsFields() {
    ...
    const fields =  {'fields':{'owner_email':'support@back4app.com','owner_name':'support@back4app.com','collaborators':[],'waiting_collaborators':[],'urls':[],'gcm_credentials':[],'pricing_plan':{},'dashboardAPI':'https://parseapi-homolog.back4app.com','databaseURL':'mongodb://admin:FkWzqrbKizPpjwEcui3wsmu9@mongohomolog.back4app.com:4000/1d51e301c93a4767b7592129e6970825','parseVersion':'5.2.3','mongoVersion':'3.6','databaseVersion':'3.6','parseOptions':{},'clientPush':false,'clientClassCreation':true}}
