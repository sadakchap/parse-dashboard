...
export default class ParseApp {
  ...
  async fetchSettingsFields() {
    ...
    const fields = {
      'fields': {
        'owner_email': 'support@back4app.com',
        'owner_name': 'support@back4app.com',
        'collaborators': [
          {
            'id': 'f920e1f3-9cb6-441d-b488-0ae9cde8ea7c',
            'userName': null,
            'userEmail': 'prasad.c@techsophy.com',
            'featuresPermission': {
              'coreSettings': 'Read',
            ...
            'classesPermission': {
              ...
              'Conversation': 'Write',
              'User': 'Write',
              'SettingPreferences': 'Write',
              'dogDocuments': 'Write',
              'dogHistory': 'Write',
              'dogMedicine': 'Write',
              'dogOvulation': 'Write',
              'dogRewards': 'Write',
              'dogTemperature': 'Write',
              'dogTraining': 'Write',
              'dogWeight': 'Write',
              'dogs': 'Write',
              'guides': 'Write',
              ...
              'poi': 'Write',
              'ratings': 'Write',
              'OrganizationBrain': 'Write',
              'Calls': 'Write',
              'Contact': 'Write',
              'schedulingOrganization': 'Write',
              'Messages': 'Write',
              'ListContacts': 'Write',
              'Message': 'Write',
              'Organization': 'Write',
              ...
              'Accommodation': 'Write',
              'Container': 'Write',
              'PointOfInterest': 'Write',
              'Instruction': 'Write',
              'animals': 'Write',
              'animalDocuments': 'Write',
              'animalHistory': 'Write',
              'animalMedicine': 'Write',
              'animalOvulation': 'Write',
              'animalRewards': 'Write',
              'animalTemperature': 'Write',
              'animalTraining': 'Write',
              'animalWeight': 'Write',
              'Artists': 'Write',
              'Groups': 'Write',
              'Timeline': 'Write',
              'TVSeries': 'Write',
              'Reviews': 'Write',
              'PhotosDatabase': 'Write',
              'Celebrities': 'Write',
              'Picture': 'Write',
              'NursingHomes': 'Write',
              'NursingHomeLayout': 'Write',
              'Invitation': 'Write',
              'Resident': 'Write',
              'TestObject': 'Write',
              'Reminder': 'Write',
              'PublicMediaCategory': 'Write',
              'NursingHomeEditedWings': 'Write',
              'PublicMedia': 'Write',
              'subscriptions': 'Write',
              'UnsubscribeResidents': 'Write',
              'FamilyMessage': 'Write',
              'CustomerService': 'Write',
              'MediaDetails': 'Write',
              'AwsCredentials': 'Write',
              'AnimatedStaffVideo': 'Write',
              'AdminAccess': 'Write',
              'RoleCNA': 'Write',
              'HelpFamilyApp': 'Write',
              'HelpNurseApp': 'Write',
              ...
              'file': 'Write',
              'ConfigPages': 'Write',
              'ConfigPages_test': 'Write',
              'themes': 'Write',
              'sectionItems': 'Write',
              'sections': 'Write',
              'AppConfigurations': 'Write',
              'InvitationCode': 'Write',
              'Community': 'Write',
              'Poll': 'Write',
              'Answer': 'Write',
              ...
              'FavoriteSong': 'Write',
              'BadgeHistory': 'Write',
              'CertificationApplication': 'Write',
              'Reward': 'Write',
              'UserData': 'Write',
              'Otp': 'Write',
              'ChatMessageHandler': 'Write',
              'MessageData': 'Write',
              'Events': 'Write',
              'CallLogs': 'Write',
              'ProxyMapping': 'Write',
              ...
              'HomePageConfig': 'Write',
              'MealPlans': 'Write',
              'Reminders': 'Write',
              'DataTypes': 'Write',
              'Notifications': 'Write',
              'ManualDataConfig': 'Write',
              'HealthData': 'Write',
              'Scores': 'Write',
              'BloodWorks': 'Write',
              'VerificationCodes': 'Write',
              'Activities': 'Write',
              'ManualGoalConfig': 'Write',
              'Measurements': 'Write',
              'ScoreWeights': 'Write',
              'SupportedRobot': 'Write',
              'CustomGeometry': 'Write',
              'Station': 'Write',
              'UserActivity': 'Write',
              'SupportedTool': 'Write',
              'CustomTool': 'Write',
              'SupportedTurntable': 'Write',
              'SupportedTrack': 'Write',
              'SupportedGeometry': 'Write',
              'CustomRobot': 'Write',
              'CustomTurntable': 'Write',
              'CustomTrack': 'Write',
              'UserRobotRelation': 'Write',
              'Device': 'Write',
              'Activity': 'Write',
              'Settings': 'Write',
              'Group': 'Write',
              ...
              'Action': 'Write',
              'complain': 'Write',
              'featureRequests': 'Write',
              'filterOptions': 'Write',
              'verifications': 'Write',
              'questions': 'Write',
              'supportConversations': 'Write',
              'supportMessages': 'Write',
              'banned': 'Write',
              'cadpartidas': 'Write',
              'Location': 'Write',
              'LocationKindle': 'Write',
              '_Product': 'Write',
              'Category': 'Write',
              'Product': 'Write',
              'Cart': 'Write',
              ...
              'Ticket': 'Write',
              'TicketType': 'Write',
              'TicketPriority': 'Write',
              'Machine': 'Write',
              'MachineStatus': 'Write',
              'TicketReport': 'Write',
              'TicketReportBeforePhoto': 'Write',
              'TicketReportDuringPhoto': 'Write',
              'TicketReportAfterPhoto': 'Write',
              'MachineComponent': 'Write',
              'MachineComponentStatus': 'Write',
              'Manteinance': 'Write',
              'ManteninanceType': 'Write',
              'MachineHistory': 'Write',
              'ScheduledManteinance': 'Write',
              'Guest': 'Write',
              'WorkerEvent': 'Write',
              'Worker': 'Write',
              'Sale': 'Write',
              ...
              'EventCircle': 'Write',
              'EventManager': 'Write',
              'EventParticipant': 'Write',
              'EventPushLog': 'Write',
              'ResetLog': 'Write',
              'Coupon': 'Write',
              'GenuineCheckItem': 'Write',
              'ChatBot': 'Write',
              'Collection': 'Write',
              'Component': 'Write',
              'Warranty': 'Write',
              ...
              'Setting': 'Write',
              'Retailer': 'Write',
              'MattressFunction': 'Write',
              'SliderItem': 'Write',
              'Customer': 'Write',
              'OrderItem': 'Write',
              'MattressMaterial': 'Write',
              'BlogCategory': 'Write',
              'GenuineCheck': 'Write',
              'Achievement': 'Write',
              'ComponentItem': 'Write',
              ...
              'CrawlerRun': 'Write',
              'Partner': 'Write',
              'SellerStatusRecord': 'Write',
              'photos': 'Write',
              'RecountJob': 'Write',
              'MasterVendor': 'Write',
              'B4aFileTest': 'Write',
              'UserLogin': 'Write',
              'VendorContacts': 'Write',
              'ListingStatusRecord': 'Write',
              'SentLetters': 'Write',
              'Brand': 'Write',
              'PartnerList': 'Write',
              'ShoppingPlatform': 'Write',
              'ItemNumber': 'Write',
              'Lead': 'Write',
              'LeadSeller': 'Write',
              'LeadParentCompany': 'Write',
              'LeadContact': 'Write',
              'LeadFile': 'Write',
              'AccountTypes': 'Write',
              'SafeSeller': 'Write',
              ...
              'MAPListing': 'Write',
              'MAPSeller': 'Write',
              'MAPInfringement': 'Write',
              'TwilioNumber': 'Write',
              'TwilioMessage': 'Write',
              'SellerDetail': 'Write',
              'ActiveMapSku': 'Write',
              'EmailTemplate': 'Write',
              'MAPEmailRecord': 'Write',
              'ActiveMapProduct': 'Write',
              'SubStatusChange': 'Write',
              'EmailDB': 'Write',
              'VendorWhiteList': 'Write',
              'EmailMatch': 'Write',
              'SellerStatusReason': 'Write',
              'MAPScreenshot': 'Write',
              'GameScore': 'Write',
              'NameChange': 'Write',
              'ProductCatalog': 'Write',
              'Affiliate': 'Write',
              'AffiliateSale': 'Write',
              'SellerStageRecord': 'Write',
              'ListingArchive': 'Write',
              'AccountJob': 'Write',
              'MAPPricingChange': 'Write',
              'Test': 'Write',
              'JFHB': 'Write',
              'POFDH': 'Write',
              'Objective': 'Write',
              ...
              'TechniqueArea': 'Write',
              'Block': 'Write',
              'ScheduleItemHistory': 'Write',
              'Risk': 'Write',
              'RiskHistory': 'Write',
              'RiskEvaluation': 'Write',
              'RiskEvaluationHistory': 'Write',
              'Vacation': 'Write',
              'MapLayer': 'Write',
              'TaskMeasurement': 'Write',
              'MyClassAbhay': 'Write',
              'pointbank2android_token': 'Write',
              'pointbank2ios_token': 'Write',
              'pointbank2android_user': 'Write',
              'pointbank2ios_user': 'Write',
              'Testclass': 'Write',
              'receiptbank_inst': 'Write',
              'smaregi_auth': 'Write',
              'smaregi_contract': 'Write',
              'License': 'Write',
              'LicenseType': 'Write',
              'SubscriptionPeriod': 'Write',
              'LicenseLog': 'Write',
              'TestClassLog': 'Write',
              'TestClass': 'Write',
              'ArucoMarkerTemplate': 'Write',
              'UserNotes': 'Write',
              'Invite': 'Write',
              'Wedding': 'Write',
              'Testimonial': 'Write'
          ...
          {
            'id': 'b78b53e3-b4b2-466d-b4b9-9eff920b57a5',
            'userName': null,
            'userEmail': 'connect@suhailshaikh.com',
            'classesPermission': []
          }
        ],
        ...
        'databaseURL': 'mongodb://admin:YD6zYks2rOyMnwumaRx2k96R@MongoS3601A.back4app.com:27017/8e18e7186ceb4ec580043c57b1dee2c9',
        'parseVersion': '4.2.0',
        'mongoVersion': '3.6',
        'parseOptions': {},
        'clientPush': false,
